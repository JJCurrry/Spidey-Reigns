...
export const DEATHS = [
  ...
  {
    id: 'death-bugle-canceled',
    title: '被取消',
    text: '号角日报用三十期专题把你钉成了「城市之耻」。你再去救人，镜头只拍你救人的「代价」。终于有一天，被你救下的人躲着你走，像躲一条旧闻。',
  },
  {
    id: 'death-ock-assimilated',
    title: '第四与第五条臂',
    text: '机械臂钻进你脊椎的那一刻，奥托的声音接管了你的喉咙：「我们终于想清楚了。」你救人的手势没变，只是落点，再也不是你选的。',
  },
  {
    id: 'death-kraven-hunt',
    title: '最伟大的战利品',
    text: '克莱文把你的战衣钉上展厅的墙，标签写「最值得的对手」。纽约照常运转，只是再没人抬头看天台——最好的猎人，已经收工回家。',
  },
